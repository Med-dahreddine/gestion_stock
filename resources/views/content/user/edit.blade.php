...
@section('title', __("Éditer les informations d'utilisateur : ".$last->name))
...
<section id="basic-input">
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="auth-register-form mt-2" method="POST" action="{{ route('user.update',request()->id) }}">
                        @csrf
                        <div class="row">
                            <x-forms.input label="name" :last="$last" name="name" cols="col-3 mb-1"/>
                            <x-forms.input label="email" :last="$last" name="email" cols="col-3 mb-1"/>
